...
<main class="grid min-h-[93vh] place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
        ...
        <p class="mt-6 text-base leading-7 text-gray-600">Access to this resources on the server is denied</p>
